...
#need to be in bids dir for script to work
...
#to populate perf subdir
    cp $dir/$i/3D_ASL_real.nii.gz  $dir2/$i/perf/sub-"$i"_asl.nii.gz
    cp $dir/$i/3D_ASL_real.json  $dir2/$i/perf/sub-"$i"_asl.json
    cp $dir/$i/3D_ASL_reala.nii.gz  $dir2/$i/perf/sub-"$i"_asl_a.nii.gz
    cp $dir/$i/3D_ASL_reala.json  $dir2/$i/perf/sub-"$i"_asl_a.json
