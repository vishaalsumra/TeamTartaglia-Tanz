...
cp /Volumes/LaCie_SSD_PRO_2TB/CIHR-FTLD_bids_conv/CIHR-FTLD_original_scans/subjects.tsv CIHR-FTLD_bids

cd CIHR-FTLD_bids
mkdir $(<subjects.tsv) #this populates the directory with subdirectories for each subject
